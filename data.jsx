...
const WEEKLY_SHIFTS = [
  { day: "วันจันทร์", date: "26 พ.ค. 2568", teacher: "อาจารย์ ศุภลักษณ์ ใจดี", students: ["ด.ญ. นภัสสร พงษ์ศิริ", "ด.ญ. ชนิตา ทองดี"], note: "ดูแลเวรถ่ายรูปภาพกิจกรรมช่วงหน้าเสาธงและคาบเช้า" },
  { day: "วันอังคาร", date: "27 พ.ค. 2568", teacher: "อาจารย์ ธนกฤต รัตนพงษ์", students: ["ด.ญ. ณัฏฐณิชา รุ่งเรือง", "ด.ญ. ปริยา เพชรงาม"], note: "ดูแลเวรเทคนิคเสียงและห้องบริการโสตฯ" },
  { day: "วันพุธ", date: "28 พ.ค. 2568", teacher: "อาจารย์ ชาญวิทย์ สมบูรณ์", students: ["ด.ญ. ปุณณภา เกียรติยศ", "ด.ญ. ภัทรานิษฐ์ สวยงาม"], note: "เตรียมอุปกรณ์ถ่ายทำและซ้อมเทคนิคไลฟ์สตรีม" },
  { day: "วันพฤหัสบดี", date: "29 พ.ค. 2568", teacher: "อาจารย์ กิตติพงษ์ แก้วใส", students: ["ด.ญ. ธีรดา ภัทรกุล", "ด.ญ. ปุณยนุช วิเศษ"], note: "อัปเดตสื่อประชาสัมพันธ์และกราฟิกกิจกรรมสัปดาห์นี้" },
  { day: "วันศุกร์", date: "30 พ.ค. 2568", teacher: "อาจารย์ ปิยะนุช ศรีสุข", students: ["ด.ญ. กมลชนก ใสสะอาด", "ด.ญ. นันท์นภัส อ่อนหวาน"], note: "เวรถ่ายภาพกิจกรรมเสริมหลักสูตรและคาบบ่าย" }
];

const DUTY_SCHEDULE = [
  {
    id: "DT-001",
    event: "ประชุมผู้ปกครองระดับชั้น ม.6",
    date: "28 พ.ค. 2568",
    time: "08:30 - 12:00 น.",
    loc: "ห้องโสตทัศนศึกษา",
    teacher: "อาจารย์ ศุภลักษณ์ ใจดี",
    staff: [
      { role: "ช่างภาพนิ่ง", name: "ด.ญ. นภัสสร พงษ์ศิริ" },
      { role: "ช่างภาพวีดิทัศน์", name: "ด.ญ. ณัฏฐณิชา รุ่งเรือง" },
      { role: "ควบคุมเสียง", name: "ด.ญ. ชนิตา ทองดี" }
    ],
    status: "upcoming"
  },
  {
    id: "DT-002",
    event: "กิจกรรมปฐมนิเทศนักเรียนใหม่ ม.1",
    date: "29 พ.ค. 2568",
    time: "09:00 - 15:30 น.",
    loc: "หอประชุมใหญ่อาคาร 8",
    teacher: "อาจารย์ สมพร วัฒนากุล",
    staff: [
      { role: "ช่างภาพนิ่ง", name: "ด.ญ. ปุณณภา เกียรติยศ" },
      { role: "ช่างภาพวีดิทัศน์", name: "ด.ญ. ธีรดา ภัทรกุล" },
      { role: "ควบคุมไลฟ์สด", name: "ด.ญ. ปุณยนุช วิเศษ" }
    ],
    status: "upcoming"
  },
  {
    id: "DT-003",
    event: "งานพิธีไหว้ครู ประจำปีการศึกษา 2568",
    date: "4 มิ.ย. 2568",
    time: "08:00 - 11:30 น.",
    loc: "โดมกิจกรรมอเนกประสงค์",
    teacher: "อาจารย์ สมพร วัฒนากุล",
    staff: [
      { role: "ช่างภาพนิ่ง (เวที)", name: "ด.ญ. นภัสสร พงษ์ศิริ" },
      { role: "ช่างภาพนิ่ง (บรรยากาศ)", name: "ด.ญ. กมลชนก ใสสะอาด" },
      { role: "ควบคุมเสียง", name: "ด.ญ. ภัทรานิษฐ์ สวยงาม" },
      { role: "ถ่ายทอดสด", name: "ด.ญ. ปุณยนุช วิเศษ" }
    ],
    status: "upcoming"
  },
  {
    id: "DT-004",
    event: "การแข่งขันกีฬาสีภายใน (ซ้อมใหญ่พาเหรด)",
    date: "10 มิ.ย. 2568",
    time: "13:00 - 16:30 น.",
    loc: "สนามฟุตบอลโรงเรียน",
    teacher: "อาจารย์ ปิยะนุช ศรีสุข",
    staff: [
      { role: "ช่างภาพนิ่ง", name: "ด.ญ. ธีรดา ภัทรกุล" },
      { role: "ช่างภาพวีดิทัศน์", name: "ด.ญ. นันท์นภัส อ่อนหวาน" }
    ],
    status: "upcoming"
  },
  {
    id: "DT-005",
    event: "อบรมคุณธรรมจริยธรรมนักเรียน ม.4",
    date: "26 พ.ค. 2568",
    time: "13:00 - 16:00 น.",
    loc: "ห้อง 8103",
    teacher: "อาจารย์ ณัฐวุฒิ บุญมา",
    staff: [
      { role: "ช่างภาพนิ่ง", name: "ด.ญ. ณัฏฐณิชา รุ่งเรือง" },
      { role: "ควบคุมเสียง", name: "ด.ญ. ปริยา เพชรงาม" }
    ],
    status: "completed"
  }
];
...
const REPORTS = [
  { id: "RP-2568-001", date: "26 พ.ค. 2568", reporter: "อ.สมพร วัฒนากุล", department: "ฝ่ายบริหาร", location: "ห้องโสตฯ", item: "ไมโครโฟนไร้สาย", description: "ไมค์ตัวที่ 2 มีเสียงซ่าเป็นระยะ", status: "pending" }
];

Object.assign(window, {
  TEACHERS, STUDENTS, ROOMS, BOOKINGS, INVENTORY,
  TRANSACTIONS, ANNOUNCES, NOTIFS, TIMELINE, GALLERY,
  ROOMS_DETAIL, WEEKLY_SHIFTS, DUTY_SCHEDULE, REPORTS
});
